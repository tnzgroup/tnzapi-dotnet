...
public class RcsControllerTests : DemoApiTestBase
{
    public RcsControllerTests(DemoApiFactory factory) : base(factory)
    {
    }
    ...
    public async Task Send_OnSuccess_Returns200WithFullResult()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/rcs/send", new { ToNumber = "+64211234567", Message = "Hello" });
    ...
    public async Task Send_WithUnparseableSendTime_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/rcs/send", new { ToNumber = "+64211234567", Message = "Hello", SendTime = "not-a-date" });
    ...
    public async Task Status_GetsCorrectSdkUrl()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/status/abc-123");

        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
        Assert.Equal("https://api.tnz.co.nz/api/v3.00/rcs/abc-123", handler.LastRequest!.RequestUri!.ToString());
    }
    ...
    public async Task Received_WithTimePeriod_PassesItThrough()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?timePeriod=60&recordsPerPage=25&page=2");
    ...
    public async Task Received_WithDateFromDateTo_PassesThemThrough()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateFrom=2026-01-01&dateTo=2026-01-31");
    ...
    public async Task Received_WithDateFromOnly_RoutesToDateFromOverload()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateFrom=2026-01-01");
    ...
    public async Task Received_WithUnparseableDateFrom_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateFrom=not-a-date");
    ...
    public async Task Received_WithUnparseableDateTo_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateFrom=2026-01-01&dateTo=not-a-date");
    ...
    public async Task Received_WithDateToOnly_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateTo=2026-01-31");
    ...
    public async Task Received_WithDateFromAfterDateTo_ReturnsBadRequestFromSdkValidationWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/rcs/received?dateFrom=2026-01-31&dateTo=2026-01-01");
    ...
    public async Task Received_WithInvalidPagination_ReturnsBadRequestWithoutCallingSdk(string query)
    {
        ...
        var response = await Client.GetAsync($"/api/rcs/received?{query}");
