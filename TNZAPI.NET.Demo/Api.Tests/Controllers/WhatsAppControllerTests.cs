...
public class WhatsAppControllerTests : DemoApiTestBase
{
    public WhatsAppControllerTests(DemoApiFactory factory) : base(factory)
    {
    }
    ...
    public async Task Send_OnSuccess_Returns200WithFullResult()
    {
        ...
        // WhatsAppApi's client-side validation requires a non-empty TemplateID (approved-template
        // messaging channel), in addition to Message.
        var response = await Client.PostAsJsonAsync("/api/whatsapp/send", new { ToNumber = "+64211234567", Message = "Hello", TemplateId = "tmpl-1" });
    ...
    public async Task Send_WithUnparseableSendTime_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.PostAsJsonAsync("/api/whatsapp/send", new { ToNumber = "+64211234567", Message = "Hello", TemplateId = "tmpl-1", SendTime = "not-a-date" });
    ...
    public async Task Status_GetsCorrectSdkUrl()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/status/abc-123");

        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
        Assert.Equal("https://api.tnz.co.nz/api/v3.00/whatsapp/abc-123", handler.LastRequest!.RequestUri!.ToString());
    }
    ...
    public async Task Received_WithTimePeriod_PassesItThrough()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?timePeriod=60&recordsPerPage=25&page=2");
    ...
    public async Task Received_WithDateFromDateTo_PassesThemThrough()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateFrom=2026-01-01&dateTo=2026-01-31");
    ...
    public async Task Received_WithDateFromOnly_RoutesToDateFromOverload()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateFrom=2026-01-01");
    ...
    public async Task Received_WithUnparseableDateFrom_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateFrom=not-a-date");
    ...
    public async Task Received_WithUnparseableDateTo_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateFrom=2026-01-01&dateTo=not-a-date");
    ...
    public async Task Received_WithDateToOnly_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateTo=2026-01-31");
    ...
    public async Task Received_WithDateFromAfterDateTo_ReturnsBadRequestFromSdkValidationWithoutCallingSdk()
    {
        ...
        var response = await Client.GetAsync("/api/whatsapp/received?dateFrom=2026-01-31&dateTo=2026-01-01");
    ...
    public async Task Received_WithInvalidPagination_ReturnsBadRequestWithoutCallingSdk(string query)
    {
        ...
        var response = await Client.GetAsync($"/api/whatsapp/received?{query}");
    ...
    public async Task Abort_SendsPatchToAbortEndpoint()
    {
        ...
        var response = await Client.PatchAsync("/api/whatsapp/abc-123/abort", null);

        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
        Assert.Equal("https://api.tnz.co.nz/api/v3.00/whatsapp/abc-123/abort", handler.LastRequest!.RequestUri!.ToString());
    }
    ...
    public async Task Reschedule_SendsPatchWithSendTime()
    {
        ...
        var response = await Client.PatchAsJsonAsync("/api/whatsapp/abc-123/reschedule", new { SendTime = "2026-08-01 09:00:00" });

        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
        Assert.Equal("https://api.tnz.co.nz/api/v3.00/whatsapp/abc-123/reschedule", handler.LastRequest!.RequestUri!.ToString());
    ...
    public async Task Reschedule_WithInvalidSendTime_ReturnsBadRequestWithoutCallingSdk()
    {
        ...
        var response = await Client.PatchAsJsonAsync("/api/whatsapp/abc-123/reschedule", new { SendTime = "not-a-date" });
