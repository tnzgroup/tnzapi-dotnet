...
namespace TNZAPI.NET.Demo.Api.Controllers
{
    ...
    public record SendTtsRequest(
        ...
        ICollection<TtsKeypadRequest>? Keypads,
    ...
    public class TtsController : ControllerBase
    {
        ...
        public TtsController(TNZApiClient client)
        {
            _client = client;
        }

        [HttpPost("send")]
        public async Task<IActionResult> Send([FromBody] SendTtsRequest request)
        {
            try
            {
                var entity = new TTSModel
                {
                ...
                var result = await _client.Messaging.TTS.SendMessageAsync(entity);
