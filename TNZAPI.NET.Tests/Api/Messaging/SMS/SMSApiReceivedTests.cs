...
public class SMSApiReceivedTests : IDisposable
{
    public void Dispose()
    {
    ...
    public async Task ReceivedAsync_GetsCorrectUrlWithQueryParams()
    {
        ...
        await sms.ReceivedAsync(timePeriod: 60, recordsPerPage: 50, page: 2);

        Assert.Equal(
            "https://api.tnz.co.nz/api/v3.00/sms/received?timePeriod=60&recordsPerPage=50&page=2",
    ...
    public async Task ReceivedAsync_UsesDefaultsWhenNotSpecified()
    {
        ...
        await sms.ReceivedAsync(timePeriod: 1440);

        Assert.Equal(
            "https://api.tnz.co.nz/api/v3.00/sms/received?timePeriod=1440&recordsPerPage=100&page=1",
            fakeHandler.LastRequest!.RequestUri!.ToString());
    }
    ...
    public async Task ReceivedAsync_ParsesMessages()
    {
        ...
        var result = await sms.ReceivedAsync(timePeriod: 60);
    ...
    public async Task ReceivedAsync_WithInvalidTimePeriod_FailsClientSideWithoutNetworkCall()
    {
        ...
        var result = await sms.ReceivedAsync(timePeriod: 0);
    ...
    public void Received_Sync_DelegatesToAsync()
    {
        ...
        var result = sms.Received(timePeriod: 60);
    ...
    public async Task ReceivedAsync_WithDateFromAndDateTo_BuildsCorrectURL()
    {
        ...
        await sms.ReceivedAsync(dateFrom: new DateTime(2026, 1, 1), dateTo: new DateTime(2026, 1, 2));
    ...
    public async Task ReceivedAsync_WithOnlyDateFrom_DefaultsDateToToNow()
    {
        ...
        var result = await sms.ReceivedAsync(dateFrom: new DateTime(2026, 1, 1));
    ...
    public async Task ReceivedAsync_WithDateFromAfterDateTo_FailsClientSideWithoutNetworkCall()
    {
        ...
        var result = await sms.ReceivedAsync(dateFrom: new DateTime(2026, 1, 2), dateTo: new DateTime(2026, 1, 1));
