...
public class TTSApiActionsTests : IDisposable
{
    public void Dispose()
    {
    ...
    public async Task RescheduleAsync_PatchesCorrectUrlWithSendTime()
    {
        ...
        await tts.RescheduleAsync(new MessageID("abc-123"), sendTime);
    ...
    public async Task AbortAsync_PatchesCorrectUrlWithNoBody()
    {
        ...
        await tts.AbortAsync(new MessageID("abc-123"));
    ...
    public async Task ResubmitAsync_PatchesCorrectUrlWithSendTime()
    {
        ...
        var result = await tts.ResubmitAsync(new MessageID("abc-123"), sendTime);
    ...
    public async Task PacingAsync_PatchesCorrectUrlWithNumberOfOperators()
    {
        ...
        var result = await tts.PacingAsync(new MessageID("abc-123"), 10);
    ...
    public async Task RescheduleAsync_WithEmptyMessageID_FailsClientSideWithoutNetworkCall()
    {
        ...
        var result = await tts.RescheduleAsync(new MessageID(""), DateTime.Now);
