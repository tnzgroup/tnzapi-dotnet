...
public class TTSBuilderTests
{
    ...
    public void Build_SetsMessageToPeople()
    {
        ...
        var model = builder
            .SetMessageToPeople("hello world")
            .Build();

        Assert.Equal("hello world", model.MessageToPeople);
    }
    ...
    public void Build_AddsKeypadsToKeypadsList()
    {
        ...
        var model = builder
            .SetMessageToPeople("hello")
            .AddKeypad(1, "Connecting you now.")
            .AddKeypad(2, "Goodbye.")
            .Build();
    ...
    public void Build_SetsAnswerPhoneFields()
    {
        ...
        var model = builder
            .SetMessageToPeople("hello")
            .SetMessageToAnswerPhones("sorry we missed you")
            .SetAnswerPhoneMode(Enums.AnswerPhoneMode.DAS)
            .Build();

        Assert.Equal("sorry we missed you", model.MessageToAnswerPhones);
