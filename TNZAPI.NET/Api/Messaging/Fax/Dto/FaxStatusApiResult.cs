...
{
    public class FaxStatusApiResult : IApiResult
    {
        ...
        public List<FaxRecipientResult> Recipients { get; set; } = new List<FaxRecipientResult>();
    }

    public class FaxRecipientResult
    {
