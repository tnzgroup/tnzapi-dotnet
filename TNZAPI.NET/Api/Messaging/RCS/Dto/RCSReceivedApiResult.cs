...
{
    public class RCSReceivedApiResult : IApiResult
    {
        ...
        public List<RCSReceivedMessage> Messages { get; set; } = new List<RCSReceivedMessage>();
    }

    public class RCSReceivedMessage
    {
