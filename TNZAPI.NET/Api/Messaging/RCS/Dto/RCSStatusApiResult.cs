...
{
    public class RCSStatusApiResult : IApiResult
    {
        ...
        public List<RCSRecipientResult> Recipients { get; set; } = new List<RCSRecipientResult>();
    }

    public class RCSRecipientResult
    {
        ...
        public decimal? Price { get; set; }
        public List<RCSReplyResult> SMSReplies { get; set; } = new List<RCSReplyResult>();
    }

    public class RCSReplyResult
    {
