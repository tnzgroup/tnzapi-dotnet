...
namespace TNZAPI.NET.Api.Messaging.RCS
{
    internal class RCSRequestBody
    {
        ...
        public List<RCSDestinationBody> Destinations { get; set; } = new List<RCSDestinationBody>();
        public List<RCSFileBody> Files { get; set; } = new List<RCSFileBody>();
    ...
    internal class RCSDestinationBody
    {
