...
{
    public class SMSStatusApiResult : IApiResult
    {
        ...
        public List<SMSRecipientResult> Recipients { get; set; } = new List<SMSRecipientResult>();
    }
    ...
    public class SMSRecipientResult
    {
        ...
        public decimal? Price { get; set; }
        public List<SMSReplyResult> SMSReplies { get; set; } = new List<SMSReplyResult>();
    }
