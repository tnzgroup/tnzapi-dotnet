...
{
    public class TTSStatusApiResult : IApiResult
    {
        ...
        public List<TTSRecipientResult> Recipients { get; set; } = new List<TTSRecipientResult>();
    }

    public class TTSRecipientResult
    {
