...
{
    public class WhatsAppStatusApiResult : IApiResult
    {
        ...
        public List<WhatsAppRecipientResult> Recipients { get; set; } = new List<WhatsAppRecipientResult>();
    }

    public class WhatsAppRecipientResult
    {
        ...
        public decimal? Price { get; set; }
        public List<WhatsAppReplyResult> SMSReplies { get; set; } = new List<WhatsAppReplyResult>();
    }

    public class WhatsAppReplyResult
    {
