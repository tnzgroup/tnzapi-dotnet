...
{
    internal class WorkflowRequestBody
    {
        ...
        public List<WorkflowDestinationBody> Destinations { get; set; } = new List<WorkflowDestinationBody>();
    ...
    internal class WorkflowDestinationBody
    {
